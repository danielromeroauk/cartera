...
class AbonoController extends \BaseController {
	...
	{
		$input = Input::only(['cartera_id', 'forma_pago', 'cuenta_id', 'monto', 'notas', 'created_at', 'user_id']);
	...
	{
		$input = Input::only(['id', 'forma_pago', 'cuenta_id', 'monto', 'notas', 'created_at', 'user_id']);
		$validador = Validator::make($input, Abono::rules());
